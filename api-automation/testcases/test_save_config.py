"""
/crm-task/v1/csTaskConfig/plus/saveConfig 接口自动化测试 (由 curl_to_test.py 自动生成)

接口信息:
    - 路径: POST /crm-task/v1/csTaskConfig/plus/saveConfig
    - Base URL: https://yupao-test-backend.yupaowang.com
    - 生成时间: 2026-06-04 17:35:11
"""
import logging
...
class TestSaveConfig:
    """/crm-task/v1/csTaskConfig/plus/saveConfig 接口测试"""
    ...
    def test_data_driven(self, http_client: HttpClient, case: dict):
        ...
        path = case.get("path", "/crm-task/v1/csTaskConfig/plus/saveConfig")
