"""
/scrm/v1/orgStaff/pageQueryOnJob 接口自动化测试 (由 curl_to_test.py 自动生成)

接口信息:
    - 路径: POST /scrm/v1/orgStaff/pageQueryOnJob
    - Base URL: https://yupao-test-backend.yupaowang.com
    - 生成时间: 2026-06-04 18:38:26
"""
import logging
...
# 加载测试数据
_data_file = "page_query_on_job.yaml"
_all_data = None
...
class TestPageQueryOnJob:
    """/scrm/v1/orgStaff/pageQueryOnJob 接口测试"""
    ...
    def test_data_driven(self, http_client: HttpClient, case: dict):
        ...
        path = case.get("path", "/scrm/v1/orgStaff/pageQueryOnJob")
