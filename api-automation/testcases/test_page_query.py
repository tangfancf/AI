"""
/trade/v1/bankTransaction/pageQuery 接口自动化测试 (由 curl_to_test.py 自动生成)

接口信息:
    - 路径: POST /trade/v1/bankTransaction/pageQuery
    - Base URL: https://yupao-test-backend.yupaowang.com
    - 生成时间: 2026-06-12 14:52:27
"""
import logging
...
class TestPageQuery:
    """/trade/v1/bankTransaction/pageQuery 接口测试"""
    ...
    def test_data_driven(self, http_client: HttpClient, case: dict):
        ...
        path = case.get("path", "/trade/v1/bankTransaction/pageQuery")
