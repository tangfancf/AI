"""
/trade/v1/bankTransaction/queryBySerialNo 接口自动化测试 (由 curl_to_test.py 自动生成)

接口信息:
    - 路径: POST /trade/v1/bankTransaction/queryBySerialNo
    - Base URL: https://yupao-test-backend.yupaowang.com
    - 生成时间: 2026-06-17 19:22:50
"""
import logging
...
# 加载测试数据
_data_file = "query_by_serial_no.yaml"
_all_data = None
...
class TestQueryBySerialNo:
    """/trade/v1/bankTransaction/queryBySerialNo 接口测试"""
    ...
    def test_data_driven(self, http_client: HttpClient, case: dict):
        ...
        path = case.get("path", "/trade/v1/bankTransaction/queryBySerialNo")
