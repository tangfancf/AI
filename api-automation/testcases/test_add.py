"""
/scrm/v1/lead/pool/visibility/rule/add 接口自动化测试 (由 curl_to_test.py 自动生成)

接口信息:
    - 路径: POST /scrm/v1/lead/pool/visibility/rule/add
    - Base URL: https://yupao-test-backend.yupaowang.com
    - 生成时间: 2026-06-17 19:12:50
"""
import logging
...
class TestAdd:
    """/scrm/v1/lead/pool/visibility/rule/add 接口测试"""
    ...
    def test_data_driven(self, http_client: HttpClient, case: dict):
        ...
        path = case.get("path", "/scrm/v1/lead/pool/visibility/rule/add")
